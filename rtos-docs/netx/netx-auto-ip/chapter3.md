---
title: Rozdział 3 — Opis Azure RTOS NetX AutoIP
description: Ten rozdział zawiera opis wszystkich usług Azure RTOS AutoIP NetX (wymienionych poniżej) w kolejności alfabetycznej.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "116796875"
---
# <a name="chapter-3---description-of-azure-rtos-netx-autoip-services"></a>Rozdział 3 — Opis Azure RTOS NetX AutoIP

Ten rozdział zawiera opis wszystkich usług Azure RTOS AutoIP NetX (wymienionych poniżej) w kolejności alfabetycznej.
...
- **NX_AUTO_IP_ERROR:**(0xA00) Błąd usuwania funkcji AutoIP.
...
Ta usługa ustawia indeks dla interfejsu sieciowego. Funkcja AutoIP będzie sondować adres IP sieci. Wartość domyślna to zero (podstawowy interfejs sieciowy). Dotyczy tylko urządzeń wieloadresowych.
...
- **NX_AUTO_IP_BAD_INTERFACE_INDEX:**(0xA02) Nieprawidłowy interfejs sieciowy 
- NX_PTR_ERROR: (0x16) Nieprawidłowy wskaźnik funkcji AutoIP.
- NX_CALLER_ERROR: (0x11) Nieprawidłowy wywołujący tę usługę.
