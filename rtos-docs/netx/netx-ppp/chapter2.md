...
---
# <a name="chapter-2---installation-and-use-of-azure-rtos-netx-point-to-point-protocol-ppp"></a>Rozdział 2 — Instalowanie i korzystanie z usługi Azure RTO NetX Point-to-Point Protocol (PPP)

Ten rozdział zawiera opis różnych problemów związanych z instalacją, konfiguracją i użyciem składnika usługi Azure RTO NetX Point-to-Point Protocol (PPP).

## <a name="product-distribution"></a>Dystrybucja produktu

Pakiet Azure RTO NetX Point-to-Point Protocol (PPP) jest dostępny pod adresem <https://github.com/azure-rtos/netx> . Pakiet zawiera następujące pliki:
...
- **NX_PPP_DNS_OPTION_DISABLE**: Jeśli jest zdefiniowana, opcja DNS jest wyłączona w odpowiedzi IPCP.  Domyślnie ta opcja nie jest zdefiniowana (opcja DNS jest ustawiona).
