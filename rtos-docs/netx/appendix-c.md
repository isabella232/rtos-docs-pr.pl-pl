---
title: Dodatek C — typy danych usługi Azure RTO NetX
description: Dowiedz się więcej o typach danych usługi Azure RTO NetX.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104821553"
---
# <a name="appendix-c---azure-rtos-netx-data-types"></a><span data-ttu-id="1cd77-103">Dodatek C — typy danych usługi Azure RTO NetX</span><span class="sxs-lookup"><span data-stu-id="1cd77-103">Appendix C - Azure RTOS NetX Data Types</span></span>

## <a name="nx_arp"></a><span data-ttu-id="1cd77-104">NX_ARP</span><span class="sxs-lookup"><span data-stu-id="1cd77-104">NX_ARP</span></span>
...
## <a name="nx_interface"></a><span data-ttu-id="1cd77-105">NX_INTERFACE</span><span class="sxs-lookup"><span data-stu-id="1cd77-105">NX_INTERFACE</span></span>
...
##  <a name="nx_ip"></a><span data-ttu-id="1cd77-106">NX_IP</span><span class="sxs-lookup"><span data-stu-id="1cd77-106">NX_IP</span></span>
...
##  <a name="nx_ip_driver"></a><span data-ttu-id="1cd77-107">NX_IP_DRIVER</span><span class="sxs-lookup"><span data-stu-id="1cd77-107">NX_IP_DRIVER</span></span>
...
## <a name="nx_ip_routing_entry"></a><span data-ttu-id="1cd77-108">NX_IP_ROUTING_ENTRY</span><span class="sxs-lookup"><span data-stu-id="1cd77-108">NX_IP_ROUTING_ENTRY</span></span>
...
## <a name="nx_packet"></a><span data-ttu-id="1cd77-109">NX_PACKET</span><span class="sxs-lookup"><span data-stu-id="1cd77-109">NX_PACKET</span></span>
...
## <a name="nx_packet_pool"></a><span data-ttu-id="1cd77-110">NX_PACKET_POOL</span><span class="sxs-lookup"><span data-stu-id="1cd77-110">NX_PACKET_POOL</span></span>
...
## <a name="nx_tcp_listen"></a><span data-ttu-id="1cd77-111">NX_TCP_LISTEN</span><span class="sxs-lookup"><span data-stu-id="1cd77-111">NX_TCP_LISTEN</span></span>
...
## <a name="nx_tcp_socket"></a><span data-ttu-id="1cd77-112">NX_TCP_SOCKET;</span><span class="sxs-lookup"><span data-stu-id="1cd77-112">NX_TCP_SOCKET;</span></span>
...
## <a name="nx_udp_socket"></a><span data-ttu-id="1cd77-113">NX_UDP_SOCKET</span><span class="sxs-lookup"><span data-stu-id="1cd77-113">NX_UDP_SOCKET</span></span>
