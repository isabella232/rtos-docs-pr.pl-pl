...
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="ec945-103">Dodatek B — plik tx_trace. h</span><span class="sxs-lookup"><span data-stu-id="ec945-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="ec945-104">W tym rozdziale przedstawiono plik **tx_trace. h** .</span><span class="sxs-lookup"><span data-stu-id="ec945-104">This chapter displays the **tx_trace.h** file.</span></span>
