...
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="b2792-103">Dodatek A — przykład tx_port. h</span><span class="sxs-lookup"><span data-stu-id="b2792-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="b2792-104">W tym rozdziale przedstawiono przykładowy plik **tx_port. h** .</span><span class="sxs-lookup"><span data-stu-id="b2792-104">This chapter displays a sample **tx_port.h** file.</span></span>
