...
---
# <a name="guix-example"></a><span data-ttu-id="bdc95-103">Przykład GUIX</span><span class="sxs-lookup"><span data-stu-id="bdc95-103">GUIX Example</span></span>

<span data-ttu-id="bdc95-104">System demonstracyjny GUIX jest dostarczany z małym przykładem, zdefiniowanym w przykładach/HelloWorld/HelloWorld. c.</span><span class="sxs-lookup"><span data-stu-id="bdc95-104">The GUIX demonstration system is delivered with a small example, defined in examples/helloworld/helloworld.c.</span></span> <span data-ttu-id="bdc95-105">W tym przykładzie przedstawiono kroki wymagane do wykonania w celu zainicjowania systemu GUIX, aby skonfigurować sterowniki ekranu.</span><span class="sxs-lookup"><span data-stu-id="bdc95-105">This example illustrates the steps needed to take to initialize the GUIX system, to set up display drivers.</span></span> <span data-ttu-id="bdc95-106">Kod źródłowy jest wymieniony na poniższych stronach.</span><span class="sxs-lookup"><span data-stu-id="bdc95-106">The source code is listed on the following pages.</span></span>
